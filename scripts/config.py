...
constants = {
    ...
    'cam_a_calibration_path': None,
    'cam_b_calibration_path': None,
    'cam_output_signal_ai_port': 'Dev1/ai6',

    'microphone_sample_rate': 125000,  # Hz
    'microphone_data_retrieval_interval': 0.25,  # n seconds between each read from DAQ buffer
